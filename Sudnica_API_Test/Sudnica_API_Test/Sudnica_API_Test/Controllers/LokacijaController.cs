...
namespace SudnicaAPI_Test.Controllers
{
    ...
    public class LokacijaController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse>> GetLokacije()
        {
            try
            {
                IEnumerable<Lokacija> lokacije = _db.Lokacije
                    .OrderBy(l => l.Id);

                _response.Result = lokacije;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResponse>> KreirajLokaciju([FromForm] LokacijaZaKreiranjeDTO lokacijaZaKreiranjeDTO)
        {
            try
            {
